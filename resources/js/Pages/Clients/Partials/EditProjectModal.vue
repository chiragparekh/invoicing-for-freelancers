...
const editingProject = computed(() => props.modelValue);
...
watch(editingProject, () => {
    editProjectForm.name = editingProject.value?.name;
});
...
const showModal = computed(() => (props.modelValue ? true : false));
                ...
                <form @submit.prevent="updateProject">
                    <div class="mt-6">
                        <div class="mt-6">
                            ...
                            <InputError
                                :message="editProjectForm.errors.name"
                                class="mt-2"
                            />
                        </div>
                        ...
                        <div class="mt-6 flex justify-end">
                            ...
                            <PrimaryButton
                                ...
                                class="ml-3"
                                :class="{
                                    'opacity-25': editProjectForm.processing,
                                }"
